...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
        <li class="nav-item ">
                <a class="nav-link active" href="http://127.0.0.1:8000/superadmin">Team Calendar</a>
            </li>
            <li class="nav-item">
...
<h3 style="color: white; border-style: solid;">Scheduled Slots: </h3>

    @foreach ($slots as $slot)
<div class="container mt-5">
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Date:{{$slot->date}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; User ID:{{$slot->user_id}}</h5>
      <h6>Project/Service: {{$slot->project}}</h6>
