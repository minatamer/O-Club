...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <li class="nav-item ">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="http://127.0.0.1:8000/user/feedback">Report Feedback</a>
            </li>
            <li class="nav-item">
...
<div class="container mt-5">
  <div class="card">
    <div class="card-body">
      ...
      <form action="{{ route('giveFeedback') }}" method="post">
      {{csrf_field()}}
        <div class="form-group">
          <label for="feedbackTitle">Which product/service you are providing feedback for?</label>
          <input type="text" class="form-control" id="feedbackTitle" name="feedbackTitle" placeholder="Which product/service you are providing feedback for?" required>
        </div>
        <div class="form-group">
          <label for="feedbackDescription">Description:</label>
          <textarea class="form-control" id="feedbackDescription" name="feedbackDescription" rows="4" placeholder="Talk about the feedback" required></textarea>
        </div>
